...
#     NO_META => q[1]
#     PREREQ_PM => { Catalyst::View::TT=>q[0], namespace::autoclean=>q[0], Catalyst::Plugin::Static::Simple=>q[0], ExtUtils::MakeMaker=>q[6.36], Catalyst::Plugin::ConfigLoader=>q[0], Catalyst::Action::RenderView=>q[0], Test::More=>q[0.88], Catalyst::Plugin::Unicode=>q[0], Catalyst::View::JSON=>q[0], Acme::LOLCAT=>q[0], Config::General=>q[0], Catalyst::Runtime=>q[5.90007], Moose=>q[0] }
#     VERSION => q[0.01]
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Jeff,,,</AUTHOR>' >> $(DISTNAME).ppd
...
installdeps ::
	$(PERL) Makefile.PL --config= --installdeps=Acme::LOLCAT,0

installdeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --installdeps=Acme::LOLCAT,0

upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Acme::LOLCAT,0,Test::More,0.88,Catalyst::Runtime,5.90007,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0,Catalyst::View::TT,0,Catalyst::View::JSON,0,Catalyst::Plugin::Unicode,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Acme::LOLCAT,0,Test::More,0.88,Catalyst::Runtime,5.90007,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0,Catalyst::View::TT,0,Catalyst::View::JSON,0,Catalyst::Plugin::Unicode,0

listdeps ::
	@$(PERL) -le "print for @ARGV" Acme::LOLCAT

listalldeps ::
	@$(PERL) -le "print for @ARGV" Acme::LOLCAT Test::More Catalyst::Runtime Catalyst::Plugin::ConfigLoader Catalyst::Plugin::Static::Simple Catalyst::Action::RenderView Moose namespace::autoclean Config::General Catalyst::View::TT Catalyst::View::JSON Catalyst::Plugin::Unicode
